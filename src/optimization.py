...
def get_optimizer(
    ...
    if optimizer.lower() == "sgd":
        ...
        # and weight_decay
        opt = torch.optim.SGD(model.parameters(), learning_rate , momentum = momentum, weight_decay= weight_decay
            # YOUR CODE HERE
        )
        ...
        # optimizer. Use the input parameters learning_rate, momentum
        # and weight_decay
        opt = torch.optim.Adam(model.parameters(), learning_rate, weight_decay=weight_decay
            # YOUR CODE HERE
        )
    else:
